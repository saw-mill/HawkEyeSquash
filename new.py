...
# from Modules.ballTracking import kalmanInit, kalmanFirstFrame
...
tp = np.zeros((2, 1), np.float32)  # prediction
...
while i < (len(frameList)-2):
    ...
    if (i + 1 == 1):
        # tp, initstate = kalmanFirstFrame(currFrame, ballCandidatesFilteredProximity, tp, mp)
